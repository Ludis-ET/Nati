  ...
  return (
    <div className="profile-page">
      <div className="page-header">
        ...
        <h2 className="page-title">Update Student Details: {mockUser.firstNameEng} {mockUser.middleNameEng} {mockUser.lastNameEng} ({mockUser.username})</h2>
      </div>
      ...
      <div className="card profile-card">
          ...
          <div className="tab-content two-col-layout">
            ...
            <div className="left-col">
              ...
              <div className="form-group">
                <label>First Name (English): <span className="req">*</span></label>
                <input type="text" value={mockUser.firstNameEng} disabled className="readonly-input" />
              </div>
              <div className="form-group">
                <label>Middle Name (English): <span className="req">*</span></label>
                <input type="text" value={mockUser.middleNameEng} disabled className="readonly-input" />
              </div>
              <div className="form-group">
                <label>Last Name (English): <span className="req">*</span></label>
                <input type="text" value={mockUser.lastNameEng} disabled className="readonly-input" />
              </div>

              <div className="form-group">
                <label>First Name (Amharic): <span className="req">*</span></label>
                <input type="text" value={mockUser.firstNameAmh} className="outlined-input" readOnly/>
              </div>
              <div className="form-group">
                <label>Middle Name (Amharic): <span className="req">*</span></label>
                <input type="text" value={mockUser.middleNameAmh} className="outlined-input" readOnly/>
              </div>
              <div className="form-group">
                <label>Last Name (Amharic): <span className="req">*</span></label>
                <input type="text" value={mockUser.lastNameAmh} className="outlined-input" readOnly/>
              </div>

              <div className="form-group mt-3">
                <label>Fayda FAN Number (16 digit) : <span className="req fw-bold"> *(Fill out this very carefully!)</span></label>
                <input type="text" placeholder="Check the FRONT side of your Fayda ID for FAN." className="outlined-input warning-border" />
              </div>
              <div className="form-group mt-3 line-after">
                <label>Fayda FIN Number (12 digit) : <span className="req fw-bold"> *(Fill out this very carefully!)</span></label>
                <input type="text" placeholder="Check the BACK side of your Fayda ID for FIN." className="outlined-input warning-border" />
              </div>
              ...
              <div className="form-group mt-3">
                ...
                <input type="email" value={mockUser.email} className="outlined-input" readOnly />
              </div>
              ...
              <div className="form-group mt-3">
                <label>Phone (Mobile): <span className="req">*</span></label>
                <input type="text" value={mockUser.phoneMobile} className="outlined-input" readOnly />
              </div>
        ...
        <div className="form-actions">
          <div className="alert-warning">
            Inputs/fields marked <span className="req">*</span> are required and you have to select or provide the required information, not marked fields are optional. Please check all tabs before updating your profile.
          </div>
